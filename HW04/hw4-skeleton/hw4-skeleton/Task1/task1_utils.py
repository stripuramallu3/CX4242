...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='CSE 6242 HW4 Task 1 utilities')
    ...
    if args.command == "test_warmup":
        from task1_utils_support import test_warmup_submission
        test_warmup_submission(args.filepath)

    if args.command == "convert":
        from task1_utils_support import convert
